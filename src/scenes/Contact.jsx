      ...
      <div className="md:flex md:justify-center gap-16 mt-5">
        ...
        >
          <form
            target="_blank"
            onSubmit={onSubmit}
            action="https://formsubmit.co/5b73db41dfa588b189b0651ef6ae0bc8"
            method="POST"
          >
            <input
            ...
            <button
              className="p-5 bg-red font-semibold text-white mt-5 hover:bg-red hover:text-yellow transition duration-500"
              type="submit"
            >
              SEND ME A MESSAGE
            </button>
